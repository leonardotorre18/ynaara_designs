...
const newMessageWhatsapp = (products, finalPrice) => {
  ...
  let message = `https://api.whatsapp.com/send/?phone=04128920206&text=%C2%A1Hola%2C+YNaara+Designs%21+👋🏼👋🏼👋🏼%0D%0A%0D%0AHice+este+pedido+desde+tu+tienda+online+${urlStore}%20📱💻%0D%0A%0D%0A`;
